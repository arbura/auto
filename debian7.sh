...
# set repo
wget -O /etc/apt/sources.list "https://raw.github.com/arbura/auto/master/sources.list.debian7"
...
# install screenfetch
cd
wget 'https://raw.github.com/arbura/auto/master/screeftech-dev'
...
wget -O /etc/nginx/nginx.conf "https://raw.github.com/arbura/auto/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Modified by arbura</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.github.com/arbura/auto/master/vps.conf"
...
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/arbura/auto/master/badvpn-udpgw64"
fi
...
wget -O bench-network.sh "https://raw.github.com/arbura/auto/master/bench-network.sh"
wget -O ps_mem.py "https://raw.github.com/pixelb/ps_mem/master/ps_mem.py"
wget -O dropmon "https://raw.github.com/arbura/auto/master/dropmon.sh"
wget -O userlogin.sh "https://raw.github.com/arbura/auto/master/userlogin.sh"
