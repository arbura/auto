...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.github.com/arbura/auto/master/centos6/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>Setup by arbura</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.github.com/arbura/auto/master/centos6/vps.conf"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.github.com/arbura/debian7/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/arbura/auto/master/centos6/vps.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.github.com/arbura/auto/master/centos6/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.github.com/arbura/auto/master/centos6/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/arbura/auto/master/centos6/1194-client.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/arbura/auto/master/centos6/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/arbura/auto/master/centos6/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.github.com/arbura/auto/master/centos6/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.github.com/arbura/auto/master/centos6/mrtg-mem.sh"
...
curl  "https://raw.github.com/arbura/auto/master/centos6/mrtg.conf" >> /etc/mrtg/mrtg.cfg
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.github.com/arbura/auto/master/centos6/squid-centos.conf"
...
# install bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.github.com/arbura/auto/master/centos6/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.github.com/arbura/auto/master/centos6/bmon"
fi
...
wget -O bench-network.sh "https://raw.github.com/arbura/auto/master/centos6/bench-network.sh"
